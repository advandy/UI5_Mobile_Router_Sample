...
sap.ui.core.mvc.Controller.extend("sap.ui.demo.tdg.view.Master", {
	...
	onSearch : function() {
		...
		var filters = [];
		var searchString = sap.ui.demo.tdg.util.Formatter.uppercaseFirstChar(this.getView().byId("searchField").getValue());
	...
	showDetail : function(oItem) {
		...
		sap.ui.core.UIComponent.getRouterFor(this).navTo("product", {			
			product: oItem.getBindingContext().getPath().slice(1),
			tab: "supplier"
		}, bReplace);
	},

	onAddProduct : function() {
		sap.ui.core.UIComponent.getRouterFor(this).myNavToWithoutHash({ //mnNavToWithoutHash is a custom function defined in MyRouter.js
